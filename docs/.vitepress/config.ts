...
// 布蒜子统计分析
  ...
  riskLink: {
    ...
    whitelist: ["https://xiaomaolin.cn/", "https://onedayxyy.cn/", "https://status.onedayxyy.cn/", "https://umami.onedayxyy.cn/", "https://zola.onedayxyy.cn/", "https://img.onedayxyy.cn/", "https://cnb.cool/onedayxyy/vitepress-theme-teek-one-public", "https://one.onedayxyy.cn/", "https://vp.teek.top/", "https://teek.seasir.top/", /https:\/\/github.com/, /https:\/\/gitee.com/, "https://github.com/xmu6", "https://gitee.com/xiaoml666"], // 白名单，匹配到的链接不提示风险
      ...
      AutoFrontmatter({
          ...
          transform: (frontMatter: Record<string, any>, fileInfo: FileInfo) => {
              ...
              const rules: TransformRule[] = [
                  ...
                  { folderName: "Python", prefix: "/python/$uuid5", removeLevel: 99}, // 清空前缀并且添加前缀使用随机数
                  { folderName: "AI", prefix: "/ai/$uuid5", removeLevel: 99}, // 清空前缀并且添加前缀使用随机数
